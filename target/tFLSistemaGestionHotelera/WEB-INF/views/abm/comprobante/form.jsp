				...
				<div class="body">
					<div class="row clearfix">
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
							<label for="email_address_2">Client</label>
						</div>
						<div class="col-md-10">
				...
				<div class="body">
					...
					<c:choose>
						...
						<c:otherwise>
							<div class="row clearfix">
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
									<label for="ptoVenta">Point of Sale</label>
								</div>
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="form-group">
										<div class="form-line">
					...
					<div class="row clearfix">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
							<label for="email_address_2">Date Voucher</label>
						</div>
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
							<div class="form-group">
								<div class="form-line">
				...
				<div class="body">
					<div class="row clearfix">
						<div
							...
							<label for="email_address_2">Concepts</label>
						</div>
						...
						<div
							class="col-lg-3 col-md-3 col-sm-3 col-xs-3 form-control-label">
							<label for="email_address_2">Form of Payment</label>
						</div>
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
						...
						<div
							class="col-lg-3 col-md-3 col-sm-3 col-xs-3 form-control-label">
							<label for="email_address_2">Coin</label>
						</div>
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
				...
				<div class="body">
					<ul class="nav nav-tabs tab-nav-right" id="myTab" role="tablist">
						<li class="active" role="presentation"><a id="conceptos-tab"
							...
							aria-controls="conceptos">CONCEPTS</a></li>
					...
					<div class="tab-content">
						<div class="tab-pane fade in active" id="conceptos-tab-pane"
													...
													<c:when test="${conceptos.preTicket != null}">
														...
														<td class="col-md-2"><select id="tipoIva-${i.index}"
															...
															class="form-control input-sm selectTipoIva">
																<option value="1">Not taxed</option>
							...
							<button type="button" class="btn btn-primary waves-effect"
								onclick="agregarConcepto()">Add Concept</button>
							<button type="button" class="btn btn-primary waves-effect"
								onclick="agregarPreTicket()">Add Pre-Ticket</button>
						...
						<div class="tab-pane fade" id="alicuotas-tab-pane" role="tabpanel"
							...
							<div class="col-md-4">
								<div class="form-group col-md-12">
									<label class="col-md-5 control-label" for="importeNeto">Amount Net</label>
									<div class="col-md-7">
								...
								<div class="form-group col-md-12">
									<label class="col-md-5 control-label" for="importeNoGravado">Amount Not Taxed</label>
									<div class="col-md-7">
								...
								<div class="form-group col-md-12">
									<label class="col-md-5 control-label" for="importeExcento">Excess Amount</label>
									<div class="col-md-7">
					...
					<div class="card">
						...
						<div class="body">
							<div class="row clearfix">
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
									<label for="">Expiration Cae</label>
								</div>
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="form-group">
								...
								<div class="col-md-6">
									<a class="btn btn-block btn-lg btn-primary waves-effect"
										target="_blank"
										href="<c:url value='/comprobante/Download/${entity.idComprobante}'/>">Download Voucher</a>
								</div>
								
								<div class="col-md-6">
									<a class="btn btn-block btn-lg btn-primary waves-effect" onclick="enviarComprobante(${entity.idComprobante})">Send by Email </a>
								</div>
								<div  id ="loaderMail">
				...
				<div class="body">
					<div class="row clearfix">
						...
						<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<label class="col-lg-5 col-md-5 col-sm-5 col-xs-5 control-label" for="totalIva">Amount IVA</label>
						...
						<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<label class="col-lg-5 col-md-5 col-sm-5 col-xs-5 control-label" for="importeTotal">Total Amount</label>
							<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
						...
						<c:when test="${entity.cae == null}">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 m-b-20">
								<a class="btn btn-block btn-lg btn-success waves-effect"
									onclick="facturar()">SAVE AND ISSUE</a>
							</div>
						</c:when>
					</c:choose>
				</div>
						...
						<c:when test="${entity.cae == null}">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 m-b-20">
								<a class="btn btn-block btn-lg btn-default waves-effect"
									href="<c:url value='list' />">BACK</a>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 m-b-20">
								<a class="btn btn-block btn-lg btn-primary waves-effect"
									onclick="guardar()">SAVE</a>
							</div>
						</c:when>
						<c:otherwise>
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 m-b-20">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">Add Pre-Tickets</h4>
			</div>
...
<div class="modal fade" id="modalItemsPreTicket" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabelItems">List of Pre-Ticket Items</h4>
			</div>
