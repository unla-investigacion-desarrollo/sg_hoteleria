					...
					<div class="row clearfix">
						...
						<div class="col-md-10">
							<form:select path="clienteComprobante"
								...
								items="${organizacion}" multiple="false"
								itemValue="idContacto" itemLabel="nombre"
								class="form-control show-tick" data-live-search="true" /> --%>
								<%-- 
								<form:select path="organizacion" items="${organizacion}" multiple="false" itemValue="idContacto" itemLabel="razonSocial" class="form-control show-tick" data-live-search="true" /> --%>
							<div class="has-error">
