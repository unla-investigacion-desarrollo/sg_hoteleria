...
<%
	...
	request.setAttribute("titulo", "List of Payment Methods");
%>

<%@include file="../../header.jsp"%>
<div class="block-header">
	<h2>
		PAYMENT METHOD <small>List of Payment Methods</a></small>
	</h2>
</div>
<c:choose>
			...
			<div class="header">
                <sec:authorize access="hasRole('ADMIN')">
					<a href="<c:url value='new' />"
						class="btn btn-primary waves-effect">Create Payment Method</a>
				</sec:authorize>
            </div>
			<div class="body">
