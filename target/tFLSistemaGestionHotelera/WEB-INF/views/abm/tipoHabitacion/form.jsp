...
<%
	request.setAttribute("titulo", "Formulario de Carga de Habitaciones");
%>
							...
							<div class="row clearfix">
								...
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="form-group">
										<div class="form-line">
											<form:input type="text" path="nombreTipoHabitacion"
												id="nombreTipoHabitacion" class="form-control" />
											<div class="has-error">
												<form:errors path="nombreTipoHabitacion" class="help-inline" />
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="form-group">
										<div class="form-line">
											<form:input type="number" path="capacidad" id="capacidad" class="form-control" />
											<div class="has-error">
												<form:errors path="capacidad" class="help-inline" />
											</div>
										</div>
									</div>
								</div>
