...
<%
	request.setAttribute("titulo", "Formulario de carga de Servicio");
%>
...
<form:form method="POST" modelAttribute="entity" class="">
			<%
				/* ******************************************************************************** *
												  ...
												  ******************************************************************************** */
			%>
			<form:input type="hidden" path="idServicio" id="id" />
						...
						<div class="body">
							<div class="row clearfix">
								...
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="form-group">
										<div class="form-line">
											<form:input type="number" step="any" path="precio" id="precio" class="form-control input-sm" />
											<div class="has-error">
								...
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="form-group">
										<div class="form-line">
											<form:select path="tipoServicio" items="${tipoServicio}"
                                            							multiple="false" itemValue="idTipoServicio"
                                            							itemLabel="descripcion" class="form-control input-sm" />
											<div class="has-error">
												<form:errors path="tipoServicio" class="help-inline" />
											</div>
										</div>
									</div>
								</div>
