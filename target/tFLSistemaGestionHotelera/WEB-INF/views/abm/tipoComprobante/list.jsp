...
<%
	...
	request.setAttribute("titulo", "List of Voucher Types");
%>

<%@include file="../../header.jsp"%>
<div class="block-header">
	<h2>
		TYPES OF VOUCHERS <small>List of Voucher Types</a></small>
	</h2>
</div>
<c:choose>
			...
			<div class="header">
                <sec:authorize access="hasRole('ADMIN')">
					<a href="<c:url value='new' />"
						class="btn btn-primary waves-effect">Create Voucher Type</a>
				</sec:authorize>
            </div>
			<div class="body">
