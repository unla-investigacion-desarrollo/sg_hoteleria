...
<%
	request.setAttribute("titulo", "Moneda");
%>
...
<form:form method="POST" modelAttribute="entity" class="">
			<%
				/* ******************************************************************************** *
												  ...
												  ******************************************************************************** */
			%>
			<form:input type="hidden" path="idMoneda" id="id" />
						...
						<div class="body">
							<div class="row clearfix">
								...
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="form-group">
										<div class="form-line">
											<form:input type="float" path="cotizacion"
												id="cotizacion" class="form-control" />
											<div class="has-error">
												<form:errors path="cotizacion" class="help-inline" />
											</div>
										</div>
									</div>
								</div>
