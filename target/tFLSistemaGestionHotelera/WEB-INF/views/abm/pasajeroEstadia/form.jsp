...
<%
	request.setAttribute("titulo", "Assign Room/Passenger to Stay");
				...
				<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header bg-blue">
							<h2>ASSIGN ROOM/PASSENGER TO STAY</h2>
						</div>
						<div class="body">
							<div class="row clearfix">
									...
									<div class="form-group">
										<div class="form-line">
											<c:choose>
                                                    ...
                                                    <c:otherwise>There are no rooms available on the date indicated.
                                                    </c:otherwise>
                                                </c:choose>
											<div class="has-error">
								...
								<c:when test="${edit}">
						             <div class="row clearfix">
						                 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 m-b-20">
						                     ...
						                     <input type="submit" id="Actualizar" href="<c:url value='list?idEstadia=${idEstadia}' />" value="SAVE" class="btn btn-block btn-lg btn-primary waves-effect" />
						                 </div>
						                 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 m-b-20">
<a class="btn btn-block btn-lg btn-default waves-effect" href="<c:url value='list' />">BACK</a>
								...
								<c:otherwise>
						             <div class="row clearfix">
						                 ...
						                 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 m-b-20">
                                            <input type="submit" id="Guardar" href="<c:url value='list?idEstadia=${idEstadia}' />" value="CREATE" class="btn btn-block btn-lg btn-primary waves-effect" />
						                 </div>
						                 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 m-b-20">
						                    <a class="btn btn-block btn-lg btn-default waves-effect" href="<c:url value='list' />">BACK</a>
						                 </div>
