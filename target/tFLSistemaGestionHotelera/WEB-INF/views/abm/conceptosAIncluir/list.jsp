...
<%
	...
	request.setAttribute("titulo", "List of Items to Include");
%>

<%@include file="../../header.jsp"%>
<div class="block-header">
	<h2>
		ITEMS TO INCLUDE <small>List of Items to Include</a></small>
	</h2>
</div>
<c:choose>
			...
			<div class="header">
                <sec:authorize access="hasRole('ADMIN')">
					<a href="<c:url value='new' />"
						class="btn btn-primary waves-effect">Create Concept to Include</a>
				</sec:authorize>
            </div>
			<div class="body">
