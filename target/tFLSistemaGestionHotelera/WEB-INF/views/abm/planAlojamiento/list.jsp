...
request.setAttribute("titulo", "Hotel Management System");
...
<div class="block-header">
	<h2>
		HOSTING PLAN <small>List of housing plans</a></small>
	</h2>
</div>
<c:choose>
			...
			<div class="header">
                <sec:authorize access="hasRole('ADMIN')">
					<a href="<c:url value='new' />"
						class="btn btn-primary waves-effect">Create Hosting Plan</a>
				</sec:authorize>
            </div>
					...
					<tbody>
						<c:forEach items="${entities}" var="entity">
							<tr>
								...
								%>
								<td>${entity.plan}</td>
                                <td>${entity.precioExtraPorNoche}</td>
