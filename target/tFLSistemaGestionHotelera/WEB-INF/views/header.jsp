...
<body class="theme-blue">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                ...
                <li class="header">MENU</li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<c:url value='/pasajero/' />">Passengers</a>
                            </li>
                            <li>
                                <a href="<c:url value='/organizacion/' />">Organizations</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<c:url value='/servicio/' />">Services</a>
                            </li>
                            <li>
                                <a href="<c:url value='/planAlojamiento/' />">Lodging Plan</a>
                            </li>
                            <li>
                                <a href="<c:url value='/estadia/' />">Stay</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li role="separator" class="divider"></li>
                            <li>
                                <a href="<c:url value='/tipoDocumento/' />">Document Types</a>
                            </li>
                            <li>
                                <a href="<c:url value='/caracteristicaPasajero/' />">Passenger Characteristics</a>
                            </li>
                            <li role="separator" class="divider"></li>
                            <li>
                                <a href="<c:url value='/hotel/' />">Hotels</a>
                            </li>
                            <li>
                                <a href="<c:url value='/tipoHabitacion/' />">Room Types</a>
                            </li>
                            <li>
                                <a href="<c:url value='/caracteristicaHabitacion/' />">Room Features</a>
                            </li>
                            <li>
                                <a href="<c:url value='/estadoHabitacion/' />">Room Statuses</a>
                            </li>
                            <li>
                                <a href="<c:url value='/habitacion/' />">Rooms</a>
                            </li>
                            <li>
                                <a href="<c:url value='/tipoServicio/' />">Service Types</a>
                            </li>
                            <li>
                                <a href="<c:url value='/estadoEstadia/' />">States Stay</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<c:url value='/comprobante/' />">Vouchers</a>
                            </li>
                            <li>
                                <a href="<c:url value='/preticket/' />">Pre-Tickets</a>
                            </li>
                            <li>
                                <a href="<c:url value='/tipoComprobante/' />">Types of Vouchers</a>
                            </li>
                            <li>
                                <a href="<c:url value='/conceptosAIncluir/' />">Concepts</a>
                            </li>
                            <li>
                                <a href="<c:url value='/formaDePago/' />">Payment Methods</a>
                            </li>
                            <li>
                                <a href="<c:url value='/moneda/' />">Coins</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2022 <a href="javascript:void(0);">Hotel Management System</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 2.0.0
                </div>
