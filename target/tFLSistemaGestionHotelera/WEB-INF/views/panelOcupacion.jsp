...
<%
request.setAttribute("idTipoHabitacion", request.getParameter("idTipoHabitacion"));
%>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$( "#fechas" ).submit(function(e) {
			...
			<%-- var dato = <%= request.getParameter("idTipoHabitacion") %>; --%>
			var dato2 = document.getElementById("idTipoHabitacion").value;
			//var id =document.querySelector('#tipoHabitacion option:checked'); /*document.getElementById("tipoHabitacion").value;*/ //no funciona el getElement
			//var = idTipoHabitacion=1;
			/* if(dato2== 1 ){
				document.location.href = "?desde=" + desde +"&hasta=" + hasta +"&idTipoHabitacion=1";
			}else if(dato2== 2 ){
				document.location.href = "?desde=" + desde +"&hasta=" + hasta +"&idTipoHabitacion=2";
			}else if(dato2== 3 ){
				document.location.href = "?desde=" + desde +"&hasta=" + hasta +"&idTipoHabitacion=3";
			}else if(dato2 == 4){
				document.location.href = "?desde=" + desde +"&hasta=" + hasta +"&idTipoHabitacion=4";
			} */
			
			document.location.href = "?desde=" + desde +"&hasta=" + hasta +"&idTipoHabitacion="+dato2 ;
			e.preventDefault();
		});
...
<%-- <form:input type="hidden" path="idTipoHabitacion" id="id" />  --%>
                        ...
                        <form id="fechas" >
								...
								<div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <%-- <form:select path="tipoHabitacion"  items="${tipoHabitacion}" multiple="false" itemValue="idTipoHabitacion" itemLabel="toString" class="form-control input-sm" />
                                             <form:input type="number" path="tipoHabitacion" value="${tipoHabitacion}" /> --%>
                                             
                                             <%-- <form:select path="tipoHabitacion"
                                                multiple="false" class="form-control input-sm" >
                                                <form:option  value="" />
                                                <form:options items="${tipoHabitacion}" itemValue="idTipoHabitacion"
                                                itemLabel="nombreTipoHabitacion" />
                                            </form:select> --%>
                                            <br>
                                            <label for="idTipoHabitacion">Choose room type:</label>
                                            <select name="idTipoHabitacion" id="idTipoHabitacion" >
                                             ...
                                             <form:input type="hidden" path="tipoHabitacion" value="${idTipoHabitacion}" /> 
									...
									<div class="form-group">
										<div class="form-group col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <form:input type="date" path="desde" id="desde" class=" form-control input-sm" value="${desde}"/>
                                            </div>
                                        </div>
									</div>
								</div>
								...
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="form-group">
										<div class="form-group col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <form:input type="date" path="hasta" id="hasta" class=" form-control input-sm" value="${hasta}"/>
                                            </div>
                                        </div>
									</div>
								</div>
                            ...
                            <div class="row clearfix">
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 m-b-20">
                                        <input type="submit" id="btnSubmit" value="Consult" class="btn btn-block btn-lg btn-primary waves-effect" />
                                    </div>
                            </div>
                        </form>
                    </div>
