...
public class FECAEAResponse  implements java.io.Serializable {
    private FECAEACabResponse feCabResp;

    private FECAEADetResponse[] feDetResp;
     ...
     * @param feCabResp
     */
    public void setFeCabResp(FECAEACabResponse feCabResp) {
        this.feCabResp = feCabResp;
    }
     ...
     * @return feDetResp
     */
    public FECAEADetResponse[] getFeDetResp() {
        return feDetResp;
    }
     ...
     * @param feDetResp
     */
    public void setFeDetResp(FECAEADetResponse[] feDetResp) {
        this.feDetResp = feDetResp;
    }
