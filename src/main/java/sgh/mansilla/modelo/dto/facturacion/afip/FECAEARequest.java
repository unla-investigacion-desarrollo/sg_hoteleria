...
public class FECAEARequest  implements java.io.Serializable {
    private FECAEACabRequest feCabReq;

    private FECAEADetRequest[] feDetReq;
     ...
     * @param feCabReq
     */
    public void setFeCabReq(FECAEACabRequest feCabReq) {
        this.feCabReq = feCabReq;
    }
     ...
     * @return feDetReq
     */
    public FECAEADetRequest[] getFeDetReq() {
        return feDetReq;
    }
     ...
     * @param feDetReq
     */
    public void setFeDetReq(FECAEADetRequest[] feDetReq) {
        this.feDetReq = feDetReq;
    }
