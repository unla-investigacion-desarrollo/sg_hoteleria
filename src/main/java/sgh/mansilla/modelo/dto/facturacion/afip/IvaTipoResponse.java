...
public class IvaTipoResponse  implements java.io.Serializable {
     ...
     * @param resultGet
     */
    public void setResultGet(IvaTipo[] resultGet) {
        this.resultGet = resultGet;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof IvaTipoResponse)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(IvaTipoResponse.class, true);
