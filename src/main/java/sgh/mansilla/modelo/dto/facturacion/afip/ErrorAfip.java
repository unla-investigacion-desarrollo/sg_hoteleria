...
public class ErrorAfip  implements java.io.Serializable {
    private int code;
    ...
    public ErrorAfip(int code,java.lang.String msg) {
           this.code = code;
           this.msg = msg;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ErrorAfip)) return false;
        ErrorAfip other = (ErrorAfip) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ErrorAfip.class, true);
