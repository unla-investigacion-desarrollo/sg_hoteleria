...
<%
	...
	request.setAttribute("titulo", "Lista de Formas de Pago");
%>

<%@include file="../../header.jsp"%>
<div class="block-header">
	<h2>
		FORMA DE PAGO <small>Lista de Formas de Pago</a></small>
	</h2>
</div>
<c:choose>
			...
			<div class="header">
                <sec:authorize access="hasRole('ADMIN')">
					<a href="<c:url value='new' />"
						class="btn btn-primary waves-effect">Crear Forma de Pago</a>
				</sec:authorize>
            </div>
			<div class="body">
