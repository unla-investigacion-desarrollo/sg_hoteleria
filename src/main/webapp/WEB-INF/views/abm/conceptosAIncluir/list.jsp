...
<%
	...
	request.setAttribute("titulo", "Lista de Conceptos a Incluir");
%>

<%@include file="../../header.jsp"%>
<div class="block-header">
	<h2>
		CONCEPTOS A INCLUIR <small>Lista de Conceptos a Incluir</a></small>
	</h2>
</div>
<c:choose>
			...
			<div class="header">
                <sec:authorize access="hasRole('ADMIN')">
					<a href="<c:url value='new' />"
						class="btn btn-primary waves-effect">Crear Concepto a Incluir</a>
				</sec:authorize>
            </div>
			<div class="body">
