...
<%
	request.setAttribute("titulo", "Tipo de Documento");
%>
					...
					<div class="card">
						...
						<div class="body">
							<div class="row clearfix">
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
									<label for="">C&oacute;digo Afip</label>
								</div>
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="form-group">
										<div class="form-line">
											<form:input type="number" min="1" path="idDocumentoAfip" id="idDocumentoAfip" class="form-control" />
											<div class="has-error">
												<form:errors path="idDocumentoAfip" class="help-inline" />
											</div>
										</div>
									</div>
								</div>
